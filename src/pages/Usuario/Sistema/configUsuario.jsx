...
import SidebarConfigUsuario from '../../../components/containers/config/configSidebarUsuario.jsx';
...
export default function ConfigUsuario() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-[#f1f5f9]">
      <SidebarConfigUsuario secaoAtiva={secaoAtiva} setSecaoAtiva={setSecaoAtiva} />
